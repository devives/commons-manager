...
public class ConcurrentStateHolderImpl extends StateHolderImpl implements ConcurrentStateHolder {

    public ConcurrentStateHolderImpl(State initialState) {
        super(initialState);
    }
    ...
    @Override
    public synchronized final void doAtomicWork(ExceptionProcedure procedure) throws Exception {
        procedure.accept();
    }

    @Override
    public synchronized final <R> R doAtomicWork(ExceptionFunction<R> function) throws Exception {
