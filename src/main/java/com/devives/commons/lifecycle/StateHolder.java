...
public interface StateHolder {
    ...
    /**
     * Execute an anonymous method.
     * <p>
     * In concurrent implementations, the method executing in {@code synchronized} code block.
     *
     * @param procedure anonymous method
     * @throws Exception thrown from anonymous method.
     */
    void doAtomicWork(ExceptionProcedure procedure) throws Exception;
     ...
     * @throws Exception thrown from anonymous method.
     */
    <R> R doAtomicWork(ExceptionFunction<R> function) throws Exception;
}