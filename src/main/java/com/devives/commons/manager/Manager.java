...
/**
 * A "keyed" manager interface.
 * <p>
 * A keyed manager maintains a manager of instances for each key value.
 * </p>
 *
 * @param <K> type of key
 * @param <O> type of managed object
 */
public interface Manager<K, O> extends CloseableObj, Iterable<O> {
