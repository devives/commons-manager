 ...
 */
public interface ManagedObjManager<K, O extends ManagedObj> extends CloseableObj, Iterable<O> {
    /**
     * @param factory factory of managed objects.
     * @return new instance of managed object.
     */
    O create(ManagedObjectFactory<K, O, ManagedObjManager<String, O>> factory);
