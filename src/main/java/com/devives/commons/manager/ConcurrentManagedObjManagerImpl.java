...
public class ConcurrentManagedObjManagerImpl<O extends ManagedObj> extends SynchronizedCloseableObjAbst implements ManagedObjManager<String, O>, Serializable {
    ...
    public void remove(O object) {
        final String key = object2keyMap_.get(new IdentityWrapper<>(object));
        if (key != null) {
