...
public class UsageCountingObjectManagerTest {
    ...
    private static void forTestManager(FailableConsumer<UsageCountingObjectManager<String, SimpleTestItem>, Exception> consumer) throws Exception {
        UsageCountingObjectManager<String, SimpleTestItem> manager = new UsageCountingManagerImpl<>();
        try {
