...
public class LazyClosableTest {

    @Test
    public void isClosed_afterNew_False() throws Exception {
        LazyCloseableImpl lazyCloseable = new LazyCloseableImpl();
    ...
    public void isClosed_afterIncUsageCount_False() throws Exception {
        LazyCloseableImpl lazyCloseable = new LazyCloseableImpl();
        try (Usage usage = Usage.of(lazyCloseable)) {
            lazyCloseable.closeAsync();
            Assertions.assertFalse(lazyCloseable.isClosed());
        }
    }
    ...
    private static class LazyCloseableImpl extends LazyCloseableAbst {
